@description('The name of the workbook. Is used to generate the workbook id.')
param name string = 'my-workbook'

@description('The friendly name for the workbook.')
param displayName string = 'My Workbook'

@description('The name of the Application Insights resource in which to create the workbook.')
...
@description('The definition of the workbook.')
var definition = {
